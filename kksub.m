%kksub 'Output = Input 1 - (Input 2 or Constant)'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros ksub.pane file
%
% Parameters: 
...
%
% Example: o = kksub({i1, i2}, {'i1','';'o','';'i2',''})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% ksub - Output = Input 1 - (Input 2 or Constant)
%
%  DESCRIPTION
% The "Subtract" operator subtracts each point in either \fBInput 2\fP 
...
%
%  "SEE ALSO"
% DATAMANIP::karith2, DATAMANIP::ksubfrom
%
%  RESTRICTIONS 
%
%  REFERENCES 
...
function varargout = kksub(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kksub(Inputs,arglist).');
end
if size(arglist,2)~=2
