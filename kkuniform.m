%kkuniform 'Introduce Uniform Noise in Input Object'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros kuniform.pane file
%
% Parameters: 
...
%
% Example: o = kkuniform(i, {'i','';'o','';'replace',0;'add',0})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% kuniform - Introduce Uniform Noise in Input Object
%
%  DESCRIPTION
% "kuniform" introduces uniform noise of the specified parameters in the
...
% The minimum (-umin) and the maximum (-umax) of the uniform distribution
% must be specified.
% 
%  "Data Type" 5
...
% DATAMANIP::kpoisson, DATAMANIP::krayleigh
%
%  RESTRICTIONS 
%
%  REFERENCES 
...
function varargout = kkuniform(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkuniform(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'knoise"  -unif'],Inputs,narglist);
