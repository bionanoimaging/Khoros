%kvedgeoff 'Remove objects touching the frame of the image window'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros vedgeoff.pane file
%
% Parameters: 
...
%
% Example: o = kvedgeoff({i, str}, {'i','';'str','';'o',''})
%
...
function varargout = kvedgeoff(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kvedgeoff(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'vedgeoff"  '],Inputs,narglist);
