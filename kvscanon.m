%kvscanon 'Sup-Canonincal Operator'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros vscanon.pane file
%
% Parameters: 
...
%
% Example: o = kvscanon({i, str1, str2}, {'i','';'str1','';'str2','';'r',1;'o',''})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% vscanon - Sup-Canonical Operator
%
%  DESCRIPTION
% .I vscanon
% will do the n-canonical transformation of an input image by a set of n structuring elements, generated after two input structuring elements.
...
%
%  EXAMPLES
% vscanon -i ball.xv -str1 b272.str -str2 b273.str -r 2 -o outimage.xv
% 
% Will do the n-canonical transformation of image "ball.xv" by a set of 4 structuring elements, generated after b272.str and b273.str, with the resulting image written to "outimage.xv".
%
%  "SEE ALSO"
%
%  RESTRICTIONS 
...
function varargout = kvscanon(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kvscanon(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'vscanon"  '],Inputs,narglist);
