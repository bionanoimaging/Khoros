%kkabsdiff 'Output = Absolute Value of (Input 1 - (Input 2 or Constant))'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros kabsdiff.pane file
%
% Parameters: 
...
%
% Example: o = kkabsdiff({i1, i2}, {'i1','';'o','';'i2',''})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% kabsdiff - Output = Absolute Value of (Input 1 - (Input 2 or Constant))
%
%  DESCRIPTION
% Output = Absolute Value(Input 1 - (Input 2 or a Constant))
% 
% The "Absolute Difference" operator computes the absolute value
% of the result of subtracting either \fBInput 2" 
% or the \fBConstant" value, which ever is specified by the user,
% from \fBInput 1".
% 
% Executing "Absolute Difference" runs the program \fIkarith2\fP 
% with the -absdiff flag.
% 
% 
...
function varargout = kkabsdiff(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkabsdiff(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'karith2"  -absdiff'],Inputs,narglist);
