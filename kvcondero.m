%kvcondero 'Conditional Erosion'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros vcondero.pane file
%
% Parameters: 
...
%
% Example: o = kvcondero({i1, i2, str}, {'i1','';'i2','';'str','';'o',''})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% vcondero - Conditional Erosion
%
%  DESCRIPTION
% .I vcondero
% will do the cond. erosion of the first input image by a set structuring element, using the second input image as a conditional image.
% 
...
%
%  EXAMPLES
% vcondero -i1 ball.xv -i2 feath.xv -str b272.str -o outimage.xv
% 
% Will do the cond. erosion of image 1 "ball.xv" by the structuring set b272.str using "feath.xv" as a conditional image, with the resulting image written to "outimage.xv".
%
%  "SEE ALSO"
% vcast1(1)
%
...
function varargout = kvcondero(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kvcondero(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'vcondero"  '],Inputs,narglist);
