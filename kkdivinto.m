%kkdivinto 'Output = (Input 2 or Constant) / Input 1'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros kdivinto.pane file
%
% Parameters: 
% InputFile: i1 'Input ', required: 'First Input data object'
% OutputFile: o 'Output', required: 'Resulting output data object'
% InputFile: i2 'Input 2', optional: 'Second input data object'
%
% Example: o = kkdivinto({i1, i2}, {'i1','';'o','';'i2',''})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% kdivinto - Output = (Input 2 or Constant) / Input 1
%
%  DESCRIPTION
% The "Divide Into" operator divides either the \fBConstant\fP value(s), or
% each point in \fBInput 2", which
% ever is specified by the user, by \fBInput 1".
% 
% Executing "Divide" runs the program \fIkarith2\fP with the -divinto flag.
% 
% 
...
%
%  "SEE ALSO"
% DATAMANIP::karith2, DATAMANIP::kdiv
%
%  RESTRICTIONS 
%
%  REFERENCES 
...
function varargout = kkdivinto(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkdivinto(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'karith2"  -divinto'],Inputs,narglist);
