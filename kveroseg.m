%kveroseg 'Erosion by a straight line segment'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros veroseg.pane file
%
% Parameters: 
...
%
% Example: o = kveroseg(i, {'i','';'alfa',0;'length',5;'o',''})
%
...
function varargout = kveroseg(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kveroseg(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'veroseg"  '],Inputs,narglist);
