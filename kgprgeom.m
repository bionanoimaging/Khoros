%kgprgeom 'Print ASCII Report of Geometry Input'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros gprgeom.pane file
%
% Parameters: 
% InputFile: i 'Input Geometry Object', required: 'input geometry object'
% Toggle: loc 'Location', default: 0: 'print location data'
% Toggle: color 'Color', default: 0: 'print color data'
% Toggle: normrad 'Normals/Radii', default: 0: 'print normals or radii'
% Toggle: tc 'Texture Coords', default: 0: 'print texture coords'
% OutputFile: o 'Output ASCII Text ', optional: 'output ASCII text file'
%
% Example: o = kgprgeom(i, {'i','';'loc',0;'color',0;'normrad',0;'tc',0;'o',''})
%
...
function varargout = kgprgeom(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kgprgeom(Inputs,arglist).');
end
if size(arglist,2)~=2
  error('arglist must be of form {''ParameterTag1'',value1;''ParameterTag2'',value2}')
 end
narglist={'i', '__input';'loc', 0;'color', 0;'normrad', 0;'tc', 0;'o', '__output'};
maxval={0,0,0,0,0,1};
minval={0,0,0,0,0,1};
istoggle=[0,1,1,1,1,1];
was_set=istoggle * 0;
paramtype={'InputFile','Toggle','Toggle','Toggle','Toggle','OutputFile'};
...
[varargout{:}]=callKhoros([w 'gprgeom"  '],Inputs,narglist);
