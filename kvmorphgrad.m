%kvmorphgrad 'Morphological Gradient'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros vmorphgrad.pane file
%
% Parameters: 
...
%
% Example: o = kvmorphgrad({i, str}, {'i','';'str','';'o',''})
%
...
function varargout = kvmorphgrad(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kvmorphgrad(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'vmorphgrad"  '],Inputs,narglist);
