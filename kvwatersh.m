%kvwatersh 'Watershed'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros vwatersh.pane file
%
% Parameters: 
...
%
% Example: o = kvwatersh(i, {'i','';'cv',2;'o',''})
%
...
function varargout = kvwatersh(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kvwatersh(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'vwatersh"  '],Inputs,narglist);
