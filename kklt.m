%kklt 'IF Input 1 is Less Than (Input 2 or Constant), Output = TRUE'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros klt.pane file
%
% Parameters: 
...
%
% Example: o = kklt({i1, i2}, {'i1','';'o','';'i2',''})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% klt - IF Input 1 is Less Than (Input 2 or Constant), Output = TRUE
%
%  DESCRIPTION
% The LESS THAN comparison operator compares each point in \fBInput 1"
% either with the corresponding point in \fBInput 2" or with the
% \fBConstant" value, which ever is specified by the user.
% If the value from \fBInput 1" is less than the
...
% \fBInput 1" is not less than the value against which
...
% 
% Executing the Less Than operator runs the program "kcompare" with the -lt flag.
%
%  
%
%  EXAMPLES
...
function varargout = kklt(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kklt(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'kcompare"  -lt'],Inputs,narglist);
