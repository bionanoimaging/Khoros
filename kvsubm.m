%kvsubm 'Subtraction of Two Images'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros vsubm.pane file
%
% Parameters: 
...
%
% Example: o = kvsubm({i1, i2}, {'i1','';'o','';'i2','';'c',0})
%
...
function varargout = kvsubm(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kvsubm(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'vsubm"  '],Inputs,narglist);
