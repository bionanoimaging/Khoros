%kvcoASF 'Alternating Sequential Filter of type Closing(Opening())'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros vcoASF.pane file
%
% Parameters: 
% InputFile: i 'Input Image ', required: 'input image'
% InputFile: str 'Struct Element', required: 'Structuring Element'
% Integer: n 'Number of Open/closes', default: 5: 'number of open/closes'
% OutputFile: o 'Output Image ', required: 'resulting output image'
%
% Example: o = kvcoASF({i, str}, {'i','';'str','';'n',5;'o',''})
%
...
function varargout = kvcoASF(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kvcoASF(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'vcoASF"  '],Inputs,narglist);
