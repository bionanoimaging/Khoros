%kkfloor 'Output = Integer Floor of Input'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros kfloor.pane file
%
% Parameters: 
% InputFile: i 'Input ', required: 'Input data object'
% OutputFile: o 'Output', required: 'Resulting output data object'
%
% Example: o = kkfloor(i, {'i','';'o',''})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% kfloor - Output = Integer Floor of Input
%
%  DESCRIPTION
% 
% The "Floor" operator returns the integer floor of each data point in the 
% input data object, \fBInput".
% 
% Executing "Floor" runs the program \fIkarith1\fP with the -floor flag.
% 
%  "\fBData Type"" 5
...
function varargout = kkfloor(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkfloor(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'karith1"  -floor'],Inputs,narglist);
