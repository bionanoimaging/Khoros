%kkfraction 'Output = Fractional Part of Input'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros kfraction.pane file
%
% Parameters: 
% InputFile: i 'Input ', required: 'Input data object'
% OutputFile: o 'Output', required: 'Resulting output data object'
%
% Example: o = kkfraction(i, {'i','';'o',''})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% kfraction - Output = Fractional Part of Input
%
%  DESCRIPTION
% 
% The "Fractional Part" operator returns the fractional part of
% each data point in the input data object, \fBInput".
% 
% Executing "Fractional Part" runs the program \fIkarith1\fP
% with the -fract flag.
% 
%  "\fBData Type"" 5
...
function varargout = kkfraction(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkfraction(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'karith1"  -fract'],Inputs,narglist);
