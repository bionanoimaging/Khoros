%kksubfrom 'Output = (Input 2 or Constant) - Input 1'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros ksubfrom.pane file
%
% Parameters: 
...
%
% Example: o = kksubfrom({i1, i2}, {'i1','';'o','';'i2',''})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% ksubfrom - Output = (Input 2 or Constant) - Input 1
%
%  DESCRIPTION
% The "Subtract From" operator subtracts each point in \fBInput 1\fP from 
% either \fBInput 2" or the \fBConstant\fP value(s), which ever is specified 
% by the user.
% 
% Executing "Subtract" runs the program \fIkarith2\fP with the -sub flag.
% 
...
%
%  "SEE ALSO"
% DATAMANIP::karith2, DATAMANIP::ksub
%
%  RESTRICTIONS 
%
%  REFERENCES 
...
function varargout = kksubfrom(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kksubfrom(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'karith2"  -subfrom'],Inputs,narglist);
