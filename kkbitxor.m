%kkbitxor 'Output = Input 1 XOR (Input 2 or Constant)'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros kbitxor.pane file
%
% Parameters: 
...
%
% Example: o = kkbitxor({i1, i2}, {'i1','';'o','';'i2','';'real',0})
%
...
%
%  DESCRIPTION
% The bitwise XOR operator performs a bitwise Exclusive OR between each point in
...
% 
% Executing \fBXOR" runs the program "kbitwise\fP with the -xor flag.
%
%  
%
%  EXAMPLES
...
function varargout = kkbitxor(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkbitxor(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'kbitwise"  -xor'],Inputs,narglist);
