%kkbitnand 'Output = NOT(Input 1) OR NOT(Input 2 or Constant)'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros kbitnand.pane file
%
% Parameters: 
...
%
% Example: o = kkbitnand({i1, i2}, {'i1','';'o','';'i2','';'real',1})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% kbitnand - Output = NOT(Input 1)  OR  NOT(Input 2 or Constant)
%
%  DESCRIPTION
% The bitwise NAND operator performs a bitwise NAND between each point in
% \fBInput 1" and either \fBInput 2\fP or the \fBConstant\fP value, which
...
% 
% Executing \fBNAND" runs the program "kbitwise\fP with the -nand flag.
%
%  
%
%  EXAMPLES
...
function varargout = kkbitnand(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkbitnand(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'kbitwise"  -nand'],Inputs,narglist);
