%kkceiling 'Output = Integer Ceiling of Input'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros kceiling.pane file
%
% Parameters: 
% InputFile: i 'Input ', required: 'Input data object'
% OutputFile: o 'Output', required: 'Resulting output data object'
%
% Example: o = kkceiling(i, {'i','';'o',''})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% kceiling - Output = Integer Ceiling of Input
%
%  DESCRIPTION
% The "Ceiling" operator returns the integer ceiling of each data point in 
% the input data object, \fBInput".
% 
% Executing "Ceiling" runs the program \fIkarith1\fP 
% with the -ceil flag.
% 
% 
%  "\fBData Type"" 5
...
function varargout = kkceiling(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkceiling(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'karith1"  -ceil'],Inputs,narglist);
