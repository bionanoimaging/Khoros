%kkbitand 'Output = Input 1 AND (Input 2 or Constant)'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros kbitand.pane file
%
% Parameters: 
...
%
% Example: o = kkbitand({i1, i2}, {'i1','';'o','';'i2','';'real',1})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% kbitand - Output = Input 1  AND  (Input 2 or Constant)
%
%  DESCRIPTION
% The bitwise AND operator, kbitand, performs a bitwise AND operation
...
% 
% Executing \fBAND" runs the program "kbitwise\fP with the -and flag.
%
%  
%
%  EXAMPLES
...
function varargout = kkbitand(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkbitand(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'kbitwise"  -and'],Inputs,narglist);
