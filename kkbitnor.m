%kkbitnor 'Output = NOT(Input 1) AND NOT(Input 2 or Constant)'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros kbitnor.pane file
%
% Parameters: 
...
%
% Example: o = kkbitnor({i1, i2}, {'i1','';'o','';'i2','';'real',0})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% kbitnor - Output = NOT(Input 1)  AND  NOT(Input 2 or Constant)
%
%  DESCRIPTION
% The bitwise NOR operator performs a bitwise NOR operation between each point in
...
% 
% Executing \fBNOR" runs the program "kbitwise\fP with the -nor flag.
%
%  
%
%  EXAMPLES
...
function varargout = kkbitnor(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkbitnor(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'kbitwise"  -nor'],Inputs,narglist);
