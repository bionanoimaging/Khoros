%kkbitclear 'Set All Bits to Zero'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros kbitclear.pane file
%
% Parameters: 
% InputFile: i 'Input ', required: 'Input data object'
% OutputFile: o 'Output', required: 'Resulting output data object'
%
% Example: o = kkbitclear(i, {'i','';'o',''})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% kbitclear - Set All Bits to Zero
%
%  DESCRIPTION
% The "CLEAR" operator sets all bits to zero on each data
% point in the input data object, \fBInput".  
% 
% Executing "CLEAR" runs the program \fIkarith1\fP with the -clear flag.
% 
% 
%  "\fBData Type"" 5
...
function varargout = kkbitclear(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkbitclear(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'karith1"  -clear'],Inputs,narglist);
