%kvextintersec 'Extended Intersection'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros vextintersec.pane file
%
% Parameters: 
% InputFile: i1 'Input Image #1', required: 'first input image'
% InputFile: i2 'Input Image #2', required: 'second input image'
% InputFile: i3 'Input Image #3', optional: 'first input image'
% InputFile: i4 'Input Image #4', optional: 'second input image'
% InputFile: i5 'Input Image #5', optional: 'first input image'
% InputFile: i6 'Input Image #6', optional: 'second input image'
% OutputFile: o 'Output Image ', required: 'resulting output image'
%
% Example: o = kvextintersec({i1, i2, i3, i4, i5, i6}, {'i1','';'i2','';'i3','';'i4','';'i5','';'i6','';'o',''})
%
...
function varargout = kvextintersec(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kvextintersec(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'vextintersec"  '],Inputs,narglist);
