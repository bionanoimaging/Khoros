%kkminimum 'Returns Lower Value between Input 1 and (Input 2 or Constant)'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros kminimum.pane file
%
% Parameters: 
...
%
% Example: o = kkminimum({i1, i2}, {'i1','';'o','';'i2',''})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% kminimum - Returns Lower Value between Input 1 and (Input 2 or Constant)
%
%  DESCRIPTION
...
% ever is specified by the user), and returns the minimum of the two values.
% 
% Executing "Clip Minimum" runs the program \fIkarith2\fP with the -min flag.
% 
...
function varargout = kkminimum(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkminimum(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'karith2"  -min'],Inputs,narglist);
