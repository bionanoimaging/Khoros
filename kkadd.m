%kkadd 'Output = Input 1 + (Input 2 or Constant)'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros kadd.pane file
%
% Parameters: 
...
%
% Example: o = kkadd({i1, i2}, {'i1','';'o','';'i2',''})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% kadd - Output = Input 1 + (Input 2 or Constant)
%
%  DESCRIPTION
% Output = Input 1 + (Input 2 or a Constant)
% 
% The "Add" operator adds each point in \fBInput 1\fP with 
% either \fBInput 2" or the \fBConstant\fP value, which 
% ever is specified by the user.
% 
% Executing "Add" runs the program \fIkarith2\fP with the -add flag.
% 
% 
...
function varargout = kkadd(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkadd(Inputs,arglist).');
end
if size(arglist,2)~=2
