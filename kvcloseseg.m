%kvcloseseg 'Closing by a straight line segment'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros vcloseseg.pane file
%
% Parameters: 
...
%
% Example: o = kvcloseseg(i, {'i','';'alfa',0;'length',5;'o',''})
%
...
function varargout = kvcloseseg(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kvcloseseg(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'vcloseseg"  '],Inputs,narglist);
