%kkfindobj 'search for software objects in toolboxes'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros kfindobj.pane file
%
% Parameters: 
...
%
% Example: kkfindobj( {'tb',' ';'oname',' ';'type',' '})
%
...
function varargout = kkfindobj(varargin)
Inputs={};
if nargin ==0
  arglist={'',''};
elseif nargin ==1
  arglist=varargin{1};
else error('Usage: [out1,..] = kkfindobj(arglist).');
end
if size(arglist,2)~=2
  error('arglist must be of form {''ParameterTag1'',value1;''ParameterTag2'',value2}')
 end
narglist={'tb', ' ';'oname', ' ';'type', ' '};
maxval={0,0,0};
minval={0,0,0};
istoggle=[1,1,1];
was_set=istoggle * 0;
...
callKhoros([w 'kfindobj"  '],Inputs,narglist);
