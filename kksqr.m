%kksqr 'Output = Input**2'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros ksqr.pane file
%
% Parameters: 
% InputFile: i1 'Input ', required: 'Input data object'
% OutputFile: o 'Output', required: 'Resulting output data object'
%
% Example: o = kksqr(i1, {'i1','';'o',''})
%
...
%
%  DESCRIPTION
% The "Square" operator returns the square (value raised to the power of
% 2) of each data
...
% 
% Executing "Square" runs the program \fIkarith2\fP
% with the -pow flag, -real 2.0 and -imag 0.0.
% 
%  "Data Type " 5
...
function varargout = kksqr(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kksqr(Inputs,arglist).');
end
if size(arglist,2)~=2
