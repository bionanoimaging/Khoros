%kvtilt 'Add a Specified Illumination Gradient Plane to Image (K1)'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros vtilt.pane file
%
% Parameters: 
% InputFile: i 'Input Image ', required: 'input image'
% InputFile: m 'Masking Image ', optional: 'tilt operation masking image'
% Double: x 'Slope in X-dir', default: 0: 'specifies the slope in the X direction'
% Double: y 'Slope in Y-dir', default: 0: 'specifies the slope in the Y direction'
% OutputFile: o 'Output Image ', required: 'resulting output image'
%
% Example: o = kvtilt({i, m}, {'i','';'m','';'x',0;'y',0;'o',''})
%
...
function varargout = kvtilt(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kvtilt(Inputs,arglist).');
end
if size(arglist,2)~=2
  error('arglist must be of form {''ParameterTag1'',value1;''ParameterTag2'',value2}')
 end
narglist={'i', '__input';'m', '__input';'x', 0;'y', 0;'o', '__output'};
maxval={0,1,0,0,0};
minval={0,1,0,0,0};
istoggle=[0,1,1,1,0];
was_set=istoggle * 0;
paramtype={'InputFile','InputFile','Double','Double','OutputFile'};
...
[varargout{:}]=callKhoros([w 'vtilt"  '],Inputs,narglist);
