%kvtoggle 'Toggle of Two Images'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros vtoggle.pane file
%
% Parameters: 
% InputFile: i1 'Input Image #1', required: 'first input image'
% InputFile: i2 'Input Image #2', required: 'second input image'
% InputFile: i3 'Input Image #3', required: 'third input image'
% OutputFile: o 'Output Image ', required: 'resulting output image'
%
% Example: o = kvtoggle({i1, i2, i3}, {'i1','';'i2','';'i3','';'o',''})
%
...
function varargout = kvtoggle(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kvtoggle(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'vtoggle"  '],Inputs,narglist);
