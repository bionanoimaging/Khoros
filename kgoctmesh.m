%kgoctmesh 'Create an Octmesh Geometry Object from 3D Data'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros goctmesh.pane file
%
% Parameters: 
% InputFile: i 'Input 3D Data Object', required: 'input 3d data for octmesh'
% InputFile: cmap 'Vis Colormap', optional: 'input vis colormap'
% String: name 'Name ', default: 'octmesh': 'object name'
% OutputFile: o 'Output Transport Name ', required: 'output geometry octmesh'
%
% Example: o = kgoctmesh({i, cmap}, {'i','';'cmap','';'name','octmesh';'o',''})
%
...
function varargout = kgoctmesh(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kgoctmesh(Inputs,arglist).');
end
if size(arglist,2)~=2
  error('arglist must be of form {''ParameterTag1'',value1;''ParameterTag2'',value2}')
 end
narglist={'i', '__input';'cmap', '__input';'name', 'octmesh';'o', '__output'};
maxval={0,1,0,0};
minval={0,1,0,0};
istoggle=[0,1,1,0];
was_set=istoggle * 0;
...
[varargout{:}]=callKhoros([w 'goctmesh"  '],Inputs,narglist);
