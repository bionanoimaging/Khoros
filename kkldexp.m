%kkldexp 'Output = Input 1 * 2**(Input 2 or Constant)'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros kldexp.pane file
%
% Parameters: 
...
%
% Example: o = kkldexp({i1, i2}, {'i1','';'o','';'i2',''})
%
...
%
%  DESCRIPTION
% The "ldexp" operator multiplies each point in \fBInput 1\fP with the 
% result of 2 taken to the power of either \fBInput 2" or the \fBConstant\fP 
% value, whichever is specified by the user.
% 
% Executing "ldexp" runs the program \fIkarith2\fP with the -ldexp flag.
% 
...
function varargout = kkldexp(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkldexp(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'karith2"  -ldexp'],Inputs,narglist);
