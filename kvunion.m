%kvunion 'Union of Two Images'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros vunion.pane file
%
% Parameters: 
...
% Integer: c 'Constant Image', default: 0: 'sub constant'
%
% Example: o = kvunion({i1, i2}, {'i1','';'o','';'i2','';'c',0})
%
...
function varargout = kvunion(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kvunion(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'vunion"  '],Inputs,narglist);
