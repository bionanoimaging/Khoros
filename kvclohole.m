%kvclohole 'Closing of Holes'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros vclohole.pane file
%
% Parameters: 
...
%
% Example: o = kvclohole({i, str}, {'i','';'str','';'o',''})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% vclohole - Closing of Holes
%
%  DESCRIPTION
% .I vclohole
...
function varargout = kvclohole(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kvclohole(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'vclohole"  '],Inputs,narglist);
