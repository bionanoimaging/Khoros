%kkmaximum 'Returns Higher Value between Input 1 and (Input 2 or Constant)'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros kmaximum.pane file
%
% Parameters: 
...
%
% Example: o = kkmaximum({i1, i2}, {'i1','';'o','';'i2',''})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% kmaximum - Returns Higher Value between Input 1 and (Input 2 or Constant)
%
%  DESCRIPTION
% This operator compares each data point in \fBInput 1" with either the value of
% the corresponding point in \fBInput 2" or the \fBConstant\fP value (which
% ever is specified by the user), and returns the maximum of the two values.
% 
% Executing "Clip Maximum" runs the program \fIkarith2\fP with the -max flag.
% 
...
% processed, and the output object is real.
%
%  REFERENCES 
%
%  COPYRIGHT
...
function varargout = kkmaximum(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkmaximum(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'karith2"  -max'],Inputs,narglist);
