%kmcovar 'Compute Covariance Matrix'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros mcovar.pane file
%
% Parameters: 
% InputFile: i 'Input data object', required: 'Input data object'
% OutputFile: o 'Output matrix object', required: 'output matrix object'
%
% Example: o = kmcovar(i, {'i','';'o',''})
%
...
function varargout = kmcovar(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kmcovar(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'mcovar"  '],Inputs,narglist);
