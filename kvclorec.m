%kvclorec 'Sup-Reconstruction'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros vclorec.pane file
%
% Parameters: 
...
%
% Example: o = kvclorec({i1, i2, str}, {'i1','';'i2','';'str','';'o',''})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% vclorec - Sup-Reconstruction
%
%  DESCRIPTION
% .I vclorec
% will do the closing by reconstruction of an input image by a set structuring element and a conditional image.
% 
...
%
%  EXAMPLES
% vclorec -i1 ball.xv -i2 feath.xv -str b272.str -o outimage.xv
% 
% Will do the closing by reconstruction of the image 1 "ball.xv", using "feath.xv" as the conditional image, by the structuring set b272.str, with the resulting image written to "outimage.xv".
%
%  "SEE ALSO"
% vcast1(1)
%
...
function varargout = kvclorec(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kvclorec(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'vclorec"  '],Inputs,narglist);
