%kvskiz 'Skiz'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros vskiz.pane file
%
% Parameters: 
% InputFile: i 'Input Image', required: 'input image'
% OutputFile: o 'Output Image ', required: 'resulting output image'
%
% Example: o = kvskiz(i, {'i','';'o',''})
%
...
function varargout = kvskiz(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kvskiz(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'vskiz"  '],Inputs,narglist);
