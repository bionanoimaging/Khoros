%kkpow 'Output = (Input 1) ** (Input 2 or Constant)'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros kpow.pane file
%
% Parameters: 
...
%
% Example: o = kkpow({i1, i2}, {'i1','';'o','';'i2',''})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% kpow - Output = (Input 1) ** (Input 2 or Constant)
%
%  DESCRIPTION
% The "Power" operator raises each point in \fBInput 1\fP to the power
% specified either by the corresponding point in \fBInput 2" or 
% the \fBConstant" value, which ever is specified by the user.
% 
% Executing "Power" runs the program \fIkarith2\fP with the -pow flag.
% 
...
function varargout = kkpow(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkpow(Inputs,arglist).');
end
if size(arglist,2)~=2
