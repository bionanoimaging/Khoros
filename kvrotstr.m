%kvrotstr 'Rotates a structuring element'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros vrotstr.pane file
%
% Parameters: 
% InputFile: str 'Input Kernel', required: 'input Morphological Kernel'
% Integer: rot 'Rotation step', default: 1: 'the step of rotation value'
% OutputFile: o 'Output kernel ', required: 'output morphological kernel'
%
% Example: o = kvrotstr(str, {'str','';'rot',1;'o',''})
%
...
function varargout = kvrotstr(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kvrotstr(Inputs,arglist).');
end
if size(arglist,2)~=2
  error('arglist must be of form {''ParameterTag1'',value1;''ParameterTag2'',value2}')
 end
narglist={'str', '__input';'rot', 1;'o', '__output'};
maxval={0,7,0};
minval={0,0,0};
istoggle=[0,0,0];
was_set=istoggle * 0;
...
[varargout{:}]=callKhoros([w 'vrotstr"  '],Inputs,narglist);
