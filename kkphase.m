%kkphase 'Output = Phase Component of Input [atan2(imaginary, real)]'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros kphase.pane file
%
% Parameters: 
% InputFile: i 'Input ', required: 'input data object'
% OutputFile: op 'Output', required: 'resulting output data object'
%
% Example: op = kkphase(i, {'i','';'op',''})
%
...
%
%  DESCRIPTION
% The "Phase" operator returns the phase of each complex data
...
% 
% Executing "Phase" runs the program \fIkcmplx2real\fP with the -op
% output option.
%
%  
%
...
function varargout = kkphase(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkphase(Inputs,arglist).');
end
if size(arglist,2)~=2
  error('arglist must be of form {''ParameterTag1'',value1;''ParameterTag2'',value2}')
 end
narglist={'i', '__input';'op', '__output'};
maxval={0,0};
minval={0,0};
istoggle=[0,0];
was_set=istoggle * 0;
