%kvintersec 'Intersection of Two Images'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros vintersec.pane file
%
% Parameters: 
...
% Integer: c 'Constant Image', default: 255: 'sub constant'
%
% Example: o = kvintersec({i1, i2}, {'i1','';'o','';'i2','';'c',255})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% vintersec - Intersection of Two Images
%
%  DESCRIPTION
% .I vintersec
% will do the inf of two input images pixel by pixel.
% 
...
%
%  EXAMPLES
% vintersec -i1 ball.xv -i2 feath.xv -o outimage.xv
% 
% Will do the inf of image 1 "ball.xv" and image 2 "feath.xv" with the resulting
...
function varargout = kvintersec(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kvintersec(Inputs,arglist).');
end
if size(arglist,2)~=2
  error('arglist must be of form {''ParameterTag1'',value1;''ParameterTag2'',value2}')
 end
narglist={'i1', '__input';'o', '__output';'i2', '__input';'c', 255};
maxval={0,0,1,255};
minval={0,0,1,0};
istoggle=[0,0,1,1];
was_set=istoggle * 0;
...
[varargout{:}]=callKhoros([w 'vintersec"  '],Inputs,narglist);
