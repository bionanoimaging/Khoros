%kktruncate 'Output = Integer Truncate of Input'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros ktruncate.pane file
%
% Parameters: 
% InputFile: i 'Input ', required: 'Input data object'
% OutputFile: o 'Output', required: 'Resulting output data object'
%
% Example: o = kktruncate(i, {'i','';'o',''})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% ktruncate - Output = Integer Truncate of Input
%
%  DESCRIPTION
% 
% The "Truncate" operator returns the integer portion of each data point
% input data object, \fBInput".
% 
% Executing "Truncate" runs the program \fIkarith1\fP with the -trunc flag.
% 
%  "\fBData Type"" 5
...
function varargout = kktruncate(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kktruncate(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'karith1"  -trunc'],Inputs,narglist);
