%kvnclose 'Closing by N times (with respect to Minkowski addition) the structuring element'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros vnclose.pane file
%
% Parameters: 
% InputFile: i 'Input Image ', required: 'input image'
% InputFile: str 'Struct Element', required: 'Structuring Element'
% Integer: n 'Size Str. El.', default: 5: 'size of struc. el.'
% OutputFile: o 'Output Image ', required: 'resulting output image'
%
% Example: o = kvnclose({i, str}, {'i','';'str','';'n',5;'o',''})
%
...
function varargout = kvnclose(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kvnclose(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'vnclose"  '],Inputs,narglist);
