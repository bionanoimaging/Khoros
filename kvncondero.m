%kvncondero 'N times (with respect to the composition) the condition erosion'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros vncondero.pane file
%
% Parameters: 
...
% Integer: n 'Number of Erosions', default: 5: 'number of cond. erosions'
% OutputFile: o 'Output Image ', required: 'resulting output image'
%
% Example: o = kvncondero({i1, i2, str}, {'i1','';'i2','';'str','';'n',5;'o',''})
%
...
function varargout = kvncondero(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kvncondero(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'vncondero"  '],Inputs,narglist);
