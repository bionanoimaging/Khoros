%kkbitnot 'Perform Bitwise NOT (Invert) Operation on Input'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros kbitnot.pane file
%
% Parameters: 
% InputFile: i 'Input ', required: 'Input data object'
% OutputFile: o 'Output', required: 'Resulting output data object'
%
% Example: o = kkbitnot(i, {'i','';'o',''})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% kbitnot - Perform Bitwise NOT (Invert) Operation on Input
%
%  DESCRIPTION
% Output = NOT(Input) = ~(Input)
% 
% The "NOT" operator performs a bitwise NOT, or invert, on each data 
% point in the input data object, \fBInput".  
% 
% Executing "NOT" runs the program \fIkarith1\fP with the -not flag.
% 
% 
%  "\fBData Type"" 5
...
function varargout = kkbitnot(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkbitnot(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'karith1"  -not'],Inputs,narglist);
