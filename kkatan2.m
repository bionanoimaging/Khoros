%kkatan2 'Output = Arc Tangent[Input 1 / (Input 2 or Constant)]'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros katan2.pane file
%
% Parameters: 
...
%
% Example: o = kkatan2({i1, i2}, {'i1','';'o','';'i2',''})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% katan2 - Output = Arc Tangent[Input 1 / (Input 2 or Constant)]
%
%  DESCRIPTION
% The "Atan2" operator returns the Arc Tangent of the result 
% produced by dividing each point in \fBInput 1" by the 
% corresponding point in \fBInput 2" or the \fBConstant\fP 
% value, which ever is specified by the user.
% 
% Executing "Atan2" runs the program \fIkarith2\fP with the -atan2 flag.
% 
% 
...
% processed, and the output object is real.  See the "Phase"
% (kphase) or "Complex to Real" (kcmplx2real) operators for complex atan2
% calculation.
%
%  REFERENCES 
%
...
function varargout = kkatan2(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkatan2(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'karith2"  -atan2'],Inputs,narglist);
