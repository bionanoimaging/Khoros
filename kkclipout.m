%kkclipout 'Clip Data Values Outside of the Specified Range'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros kclipout.pane file
%
% Parameters: 
% InputFile: i 'Input ', required: 'Input file'
% OutputFile: o ' Output ', required: 'output file'
%
% Example: o = kkclipout(i, {'i','';'o',''})
%
...
%
%  DESCRIPTION
% The "Clip Outside" operator (kclipout) performs clipping on the Input
% data object (i) outside of the range defined by the specified Lower and Upper
% Cutoff Values (lc, uc).  
...
% 
% Executing "Clip Outside" runs the program \fIkclip\fP with the -thresh
...
function varargout = kkclipout(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkclipout(Inputs,arglist).');
end
if size(arglist,2)~=2
