%kkbitandrev 'Output = Input 1 AND NOT(Input 2 or Constant)'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros kbitandrev.pane file
%
% Parameters: 
...
%
% Example: o = kkbitandrev({i1, i2}, {'i1','';'o','';'i2','';'real',0})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% kbitandrev - Output = Input 1  AND  NOT(Input 2 or Constant)
%
%  DESCRIPTION
% The bitwise AND Reverse operator performs a bitwise NOT on either 
% \fBInput 2" or the \fBConstant\fP value, which ever is specified 
% by the user, and then performs a bitwise AND between the result of the 
% NOT operation and \fBInput 1".
% 
...
% 
% Executing \fBAND Reverse" runs the program "kbitwise\fP with 
% the -andrev flag.
%
%  
%
...
% The bitwise operators will not operate on float or complex data types.
% 
% In the future, the padding value used for this operation when the input 
% images are of different sizes, will be modified from binary 0 to binary 1.
%
%  REFERENCES 
%
%  COPYRIGHT
...
function varargout = kkbitandrev(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkbitandrev(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'kbitwise"  -andrev'],Inputs,narglist);
