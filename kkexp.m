%kkexp 'Compute Exponential (antilog)'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros kexp.pane file
%
% Parameters: 
% InputFile: i 'Input ', required: 'input data object'
% OutputFile: o 'Output', required: 'resulting output data object'
% Toggle: be 'Natural Base (2.71828...)', default: 0: 'Compute exponential using natural base 2.71828...'
% Toggle: b10 'Base 10', default: 0: 'Compute exponential using base 10'
% Toggle: b2 'Base 2', default: 0: 'Compute exponential using base 2'
%
% Example: o = kkexp(i, {'i','';'o','';'be',0;'b10',0;'b2',0})
%
...
function varargout = kkexp(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkexp(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'klogexp"  -inv'],Inputs,narglist);
