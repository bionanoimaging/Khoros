%kvlabelm 'Labeling of a binary image'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros vlabelm.pane file
%
% Parameters: 
% InputFile: i 'Input Image', required: 'input image'
% MultiChoice: cv 'Connectivity', default: 2: 'connectivity'
%    Choices are:
%   1: '4 '
%   2: '8 '
% OutputFile: o 'Output Image', required: 'resulting output image'
%
% Example: o = kvlabelm(i, {'i','';'cv',2;'o',''})
%
...
function varargout = kvlabelm(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kvlabelm(Inputs,arglist).');
end
if size(arglist,2)~=2
  error('arglist must be of form {''ParameterTag1'',value1;''ParameterTag2'',value2}')
 end
narglist={'i', '__input';'cv', 2;'o', '__output'};
maxval={0,0,0};
minval={0,0,0};
istoggle=[0,0,0];
was_set=istoggle * 0;
...
[varargout{:}]=callKhoros([w 'vlabelm"  '],Inputs,narglist);
