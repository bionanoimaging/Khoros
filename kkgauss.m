%kkgauss 'Introduce Gaussian Noise in Input Object'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros kgauss.pane file
%
% Parameters: 
...
%
% Example: o = kkgauss(i, {'i','';'o','';'replace',0;'add',0})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% kgauss - Introduce Gaussian Noise in Input Object
%
%  DESCRIPTION
% "kgauss" introduces Gaussian noise of the specified parameters in the 
...
% The mean (-gmean) and the variance (-gvar) of the Gaussian distribution 
% must be specified.
% 
%  "Data Type" 5
...
%
%  "SEE ALSO"
% DATAMANIP::knoise, DATAMANIP::kpoisson, DATAMANIP::krayleigh, 
% DATAMANIP::kexpon, DATAMANIP::kuniform
%
%  RESTRICTIONS 
%
%  REFERENCES 
...
function varargout = kkgauss(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkgauss(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'knoise"  -gauss'],Inputs,narglist);
