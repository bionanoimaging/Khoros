%kkexpand 'Expand Object Via Pixel Replication'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros kexpand.pane file
%
% Parameters: 
% InputFile: i 'Input ', required: 'Input object'
% OutputFile: o 'Output', required: 'Resulting subsampled object'
%
% Example: o = kkexpand(i, {'i','';'o',''})
%
...
% later ....
% 
% Executing "Expand Object" runs the program \fIkresample\fP with
...
function varargout = kkexpand(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkexpand(Inputs,arglist).');
end
if size(arglist,2)~=2
