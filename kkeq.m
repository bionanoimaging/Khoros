%kkeq 'IF Input 1 is Equal to (Input 2 or Constant), Output = TRUE'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros keq.pane file
%
% Parameters: 
...
%
% Example: o = kkeq({i1, i2}, {'i1','';'o','';'i2',''})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% keq - IF Input 1 is Equal to (Input 2 or Constant), Output = TRUE
%
%  DESCRIPTION
% The EQUAL comparison operator compares each point in \fBInput 1"
% either with the corresponding point in \fBInput 2" or with the 
% \fBConstant" value, which ever is specified by the user.
% If the two values are equal, the corresponding point in \fBOutput" will be 
% assigned the value specified by \fBTRUE Value".  It the values being 
% compared are not equal, the corresponding point in \fBOutput" will be
...
% 
% Executing the equal operator runs the program "kcompare" with the -eq flag.
%
%  
%
%  EXAMPLES
...
function varargout = kkeq(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkeq(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'kcompare"  -eq'],Inputs,narglist);
