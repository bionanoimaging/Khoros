%kvsymdif 'Symmetric Difference'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros vsymdif.pane file
%
% Parameters: 
% InputFile: i1 'Input Image #1', required: 'input image'
% InputFile: i2 'Input Image #2', required: 'input image'
% OutputFile: o 'Output Image', required: 'output image'
%
% Example: o = kvsymdif({i1, i2}, {'i1','';'i2','';'o',''})
%
...
function varargout = kvsymdif(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kvsymdif(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'vsymdif"  '],Inputs,narglist);
