%kknoise 'Introduce Noise in Input Object'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros knoise.pane file
%
% Parameters: 
...
%
% Example: o = kknoise(i, {'i','';'o','';'replace',0;'add',0;'gauss',0;'ray',0;'unif',0;'poiss',0;'exp',0})
%
...
function varargout = kknoise(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kknoise(Inputs,arglist).');
end
if size(arglist,2)~=2
  error('arglist must be of form {''ParameterTag1'',value1;''ParameterTag2'',value2}')
 end
narglist={'i', '__input';'o', '__output';'replace', 0;'add', 0;'gauss', 0;'ray', 0;'unif', 0;'poiss', 0;'exp', 0};
maxval={0,0,0,0,0,0,0,0,0};
minval={0,0,0,0,0,0,0,0,0};
istoggle=[0,0,1,1,1,1,1,1,1];
was_set=istoggle * 0;
paramtype={'InputFile','OutputFile','Toggle','Toggle','Toggle','Toggle','Toggle','Toggle','Toggle'};
...
[varargout{:}]=callKhoros([w 'knoise"  '],Inputs,narglist);
