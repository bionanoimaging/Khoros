%kkrename 'Renames a software object'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros krename.pane file
%
% Parameters: 
% String: tb 'Toolbox ', default: ' ': 'name of toolbox'
% String: oname 'Object ', default: ' ': 'name of object in specified toolbox'
% String: new 'New Name', default: ' ': 'new name for object'
%
% Example: kkrename( {'tb',' ';'oname',' ';'new',' '})
%
...
function varargout = kkrename(varargin)
Inputs={};
if nargin ==0
  arglist={'',''};
elseif nargin ==1
  arglist=varargin{1};
else error('Usage: [out1,..] = kkrename(arglist).');
end
if size(arglist,2)~=2
  error('arglist must be of form {''ParameterTag1'',value1;''ParameterTag2'',value2}')
 end
narglist={'tb', ' ';'oname', ' ';'new', ' '};
maxval={0,0,0};
minval={0,0,0};
istoggle=[0,0,0];
was_set=istoggle * 0;
...
callKhoros([w 'krename"  '],Inputs,narglist);
