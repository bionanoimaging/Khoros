%kmreplicate 'Replicate a Given Matrix as Submatrices of a Larger Matrix'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros mreplicate.pane file
%
% Parameters: 
% InputFile: i 'Input ', required: 'Input mmatrix data object'
% Integer: r 'Replica count along rows ', default: 1: 'replica count along rows'
% Integer: c 'Replica count along cols ', default: 1: 'replica count along columns'
% OutputFile: o 'Output', required: 'Resulting matrix output data object'
%
% Example: o = kmreplicate(i, {'i','';'r',1;'c',1;'o',''})
%
...
function varargout = kmreplicate(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kmreplicate(Inputs,arglist).');
end
if size(arglist,2)~=2
  error('arglist must be of form {''ParameterTag1'',value1;''ParameterTag2'',value2}')
 end
narglist={'i', '__input';'r', 1;'c', 1;'o', '__output'};
maxval={0,2,2,0};
minval={0,2,2,0};
istoggle=[0,1,1,0];
was_set=istoggle * 0;
...
[varargout{:}]=callKhoros([w 'mreplicate"  '],Inputs,narglist);
