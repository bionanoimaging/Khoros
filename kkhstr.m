%kkhstr 'Perform Histogram Stretching'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros khstr.pane file
%
% Parameters: 
...
%
% Example: o = kkhstr(i, {'i','';'invert',0;'o','';'whole',0;'w',0;'h',0;'d',0;'t',0;'e',0})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% khstr - Perform Histogram Stretching
%
%  DESCRIPTION
% The "Stretch Histogram" operator (khstr)
% is used to perform histogram stretching on the Input object (i).
...
% 
% Histogram stretching employs a simple linear mapping.  Stretching
% can bring out some detail but preserves the relative brightness of the data.
% Histogram stretching is described in detail in texts on image processing.
% 
...
% 
% The histogram stretching can be performed in units of data that can span any
...
% 
% Executing "Stretch Histogram" runs the program \fIkhistops\fP with 
% the -stretch flag.
%
%  
%
...
%
%  "SEE ALSO"
% DATAMANIP::khistops, DATAMANIP::kheq, DATAMANIP::khisto
%
%  RESTRICTIONS 
% 
...
function varargout = kkhstr(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkhstr(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'khistops"  -stretch'],Inputs,narglist);
