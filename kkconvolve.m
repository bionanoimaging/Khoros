%kkconvolve 'Simple convolution and correlation'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros kconvolve.pane file
%
% Parameters: 
...
% Integer: ec 'Elements ', default: 0: 'Elements coordinate of kernel hotspot'
% OutputFile: o 'Output object', required: 'output object'
%
% Example: o = kkconvolve({i1, i2}, {'i1','';'i2','';'upcast',0;'wc',0;'hc',0;'dc',0;'tc',0;'ec',0;'o',''})
%
...
%
%  DESCRIPTION
% \fBkconvolve" is a simple interface to the more general \fBklinearop\fP
% routine in the DATAMANIP toolbox. \fBkconvolve" is set up to perform
...
function varargout = kkconvolve(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkconvolve(Inputs,arglist).');
end
if size(arglist,2)~=2
  error('arglist must be of form {''ParameterTag1'',value1;''ParameterTag2'',value2}')
 end
narglist={'i1', '__input';'i2', '__input';'upcast', 0;'wc', 0;'hc', 0;'dc', 0;'tc', 0;'ec', 0;'o', '__output'};
maxval={0,0,0,1,1,1,1,1,0};
minval={0,0,0,1,1,1,1,1,0};
istoggle=[0,0,1,1,1,1,1,1,0];
was_set=istoggle * 0;
paramtype={'InputFile','InputFile','Toggle','Integer','Integer','Integer','Integer','Integer','OutputFile'};
...
[varargout{:}]=callKhoros([w 'klinearop"  -l'],Inputs,narglist);
