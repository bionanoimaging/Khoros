%kiflip 'Reflect Image Data Along Either Width Or Height Axes'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros iflip.pane file
%
% Parameters: 
...
%
% Example: o = kiflip(i, {'i','';'o','';'w',0;'h',0})
%
...
function varargout = kiflip(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kiflip(Inputs,arglist).');
end
if size(arglist,2)~=2
  error('arglist must be of form {''ParameterTag1'',value1;''ParameterTag2'',value2}')
 end
narglist={'i', '__input';'o', '__output';'w', 0;'h', 0};
maxval={0,0,0,0};
minval={0,0,0,0};
istoggle=[0,0,1,1];
was_set=istoggle * 0;
