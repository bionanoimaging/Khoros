%kkblend 'Output = (Input 1 * Constant) + (Input 2 (1 - Constant))'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros kblend.pane file
%
% Parameters: 
...
% InputFile: iratio 'Blending file', optional: 'Input object for providing blending ratios'
%
% Example: o = kkblend({i1, i2, iratio}, {'i1','';'i2','';'o','';'iratio',''})
%
...
%
%  DESCRIPTION
% The "Blend" operator (kblend) forms a blend of two objects by 
% adding X*(object1)+(1-X)*(object2).
% 
% Instead of specifying a constant for the blending ratio, an object can be 
% supplied for the blending values. The value segment of the ratio object
% is used to determine the proportion in which the two objects are blended.
% It must take on values between 0 and 1, otherwise an error is generated.
% 
% 
%  "Data Type" 5
...
function varargout = kkblend(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkblend(Inputs,arglist).');
end
if size(arglist,2)~=2
  error('arglist must be of form {''ParameterTag1'',value1;''ParameterTag2'',value2}')
 end
narglist={'i1', '__input';'i2', '__input';'o', '__output';'iratio', '__input'};
maxval={0,0,0,1};
minval={0,0,0,1};
istoggle=[0,0,0,1];
was_set=istoggle * 0;
paramtype={'InputFile','InputFile','OutputFile','InputFile'};
...
[varargout{:}]=callKhoros([w 'kblend"  '],Inputs,narglist);
