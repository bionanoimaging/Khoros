%kkbitset 'Set All Bits to One'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros kbitset.pane file
%
% Parameters: 
% InputFile: i 'Input ', required: 'Input data object'
% OutputFile: o 'Output', required: 'Resulting output data object'
%
% Example: o = kkbitset(i, {'i','';'o',''})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% kbitset - Set All Bits to One
%
%  DESCRIPTION
% The "SET" operator sets all bits to one for each data
% point in the input data object, \fBInput".  
% 
% Executing "SET" runs the program \fIkarith1\fP with the -set flag.
% 
% 
%  "\fBData Type"" 5
...
function varargout = kkbitset(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkbitset(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'karith1"  -set'],Inputs,narglist);
