%kcantata 'The visual programming language for Khoros'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros cantata.pane file
%
% Parameters: 
% Toggle: mini 'Miniaturize Cantata', default: 0: 'Create A Miniaturized version of Cantata'
% InputFile: wksp 'Cantata workspace file', optional: 'file for restoring cantata workspace'
...
%
% Example: kcantata(wksp, {'mini',0;'wksp','';'tb',' ';'oname',' '})
%
...
%  DESCRIPTION
% 
% \fBCantata" is a graphically expressed, data flow visual language which
...
function varargout = kcantata(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kcantata(Inputs,arglist).');
end
if size(arglist,2)~=2
  error('arglist must be of form {''ParameterTag1'',value1;''ParameterTag2'',value2}')
 end
narglist={'mini', 0;'wksp', '__input';'tb', ' ';'oname', ' '};
maxval={0,1,0,0};
minval={0,1,0,0};
istoggle=[1,1,1,1];
was_set=istoggle * 0;
paramtype={'Toggle','InputFile','String','String'};
...
callKhoros([w 'cantata"  '],Inputs,narglist);
