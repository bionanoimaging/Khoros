%kvhxray 'Stretch or Equilize Histogram Using Overlapping Windows (K1)'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros vhxray.pane file
%
% Parameters: 
% InputFile: i 'Input Image ', required: 'first input image'
% Integer: w 'Window Width ', default: 5: 'selects the width of the window'
% Integer: h 'Window Height ', default: 5: 'selects the height of the window'
% OutputFile: o 'Output Image ', required: 'resulting output image'
%
% Example: o = kvhxray(i, {'i','';'w',5;'h',5;'o',''})
%
...
function varargout = kvhxray(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kvhxray(Inputs,arglist).');
end
if size(arglist,2)~=2
  error('arglist must be of form {''ParameterTag1'',value1;''ParameterTag2'',value2}')
 end
narglist={'i', '__input';'w', 5;'h', 5;'o', '__output'};
maxval={0,32,32,0};
minval={0,1,1,0};
istoggle=[0,1,1,0];
was_set=istoggle * 0;
...
[varargout{:}]=callKhoros([w 'vhxray"  '],Inputs,narglist);
