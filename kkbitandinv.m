%kkbitandinv 'Output = NOT(Input 1) AND (Input 2 or Constant)'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros kbitandinv.pane file
%
% Parameters: 
...
%
% Example: o = kkbitandinv({i1, i2}, {'i1','';'o','';'i2','';'real',1})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% kbitandinv - Output = NOT(Input 1)  AND  (Input 2 or Constant)
%
%  DESCRIPTION
% The bitwise AND Inverted operator performs a bitwise NOT on \fBInput 1" 
% and then a bitwise AND between the result of the NOT operation and 
% either the corresponding value in \fBInput 2" or the \fBConstant\fP value, 
% which ever is specified by the user.
% 
...
% 
% Executing \fBANDinv" runs the program "kbitwise\fP with the -andinv flag.
%
%  
%
%  EXAMPLES
...
% The bitwise operators will not operate on float or complex data types.
% 
% In the future, the padding value used for ANDinv when the input images are of 
% different sizes, will be modified from binary 0 to binary 1.
%
%  REFERENCES 
%
%  COPYRIGHT
...
function varargout = kkbitandinv(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkbitandinv(Inputs,arglist).');
end
if size(arglist,2)~=2
  error('arglist must be of form {''ParameterTag1'',value1;''ParameterTag2'',value2}')
 end
narglist={'i1', '__input';'o', '__output';'i2', '__input';'real', 1};
maxval={0,0,1,0};
minval={0,0,1,0};
istoggle=[0,0,1,1];
was_set=istoggle * 0;
...
[varargout{:}]=callKhoros([w 'kbitwise"  -andinv'],Inputs,narglist);
