%kkbitrshift 'Bitwise RIGHT SHIFT of Input 1 by (Input 2 or Constant) Bits'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros kbitrshift.pane file
%
% Parameters: 
...
%
% Example: o = kkbitrshift({i1, i2}, {'i1','';'o','';'i2','';'real',0})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% kbitrshift - Bitwise RIGHT SHIFT of Input 1 by (Input 2 or Constant) Bits
%
%  DESCRIPTION
% The \fBRight Shift" operator performs a bitwise right shift on each point in
...
% Zero's are shifted into the
% most significant bits, and, in effect, each data value is divided by two and the
...
% 
% Executing \fBRight Shift" runs the program "kbitwise\fP with the -rs flag.
%
%  
%
%  EXAMPLES
...
function varargout = kkbitrshift(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkbitrshift(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'kbitwise"  -rs'],Inputs,narglist);
