%kvequal 'Informs if two images are equal'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros vequal.pane file
%
% Parameters: 
% InputFile: i1 'Input Image #1', required: 'input file'
% String: v 'Data Variable Name:', default: ' ': 'variable'
% OutputFile: o 'Output File', required: 'The first input file'
% InputFile: i2 'Input Image #2', optional: 'input file'
% Integer: c 'Constant Image', default: 0: 'constant value'
%
% Example: o = kvequal({i1, i2}, {'i1','';'v',' ';'o','';'i2','';'c',0})
%
...
function varargout = kvequal(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kvequal(Inputs,arglist).');
end
if size(arglist,2)~=2
  error('arglist must be of form {''ParameterTag1'',value1;''ParameterTag2'',value2}')
 end
narglist={'i1', '__input';'v', ' ';'o', '__output';'i2', '__input';'c', 0};
maxval={0,0,0,1,255};
minval={0,0,0,1,0};
istoggle=[0,0,0,1,1];
was_set=istoggle * 0;
paramtype={'InputFile','String','OutputFile','InputFile','Integer'};
...
[varargout{:}]=callKhoros([w 'vequal"  '],Inputs,narglist);
