%kvgettilt 'Compute the Best-Fit Plane Parameters for Input File (K1)'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros vgettilt.pane file
%
% Parameters: 
% InputFile: i 'Input Image ', required: 'input image'
% InputFile: m 'Masking Image', optional: 'statistics operation masking image'
% OutputFile: f 'Ouput ASCII File', required: 'output ASCII file'
%
% Example: f = kvgettilt({i, m}, {'i','';'m','';'f',''})
%
...
function varargout = kvgettilt(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kvgettilt(Inputs,arglist).');
end
if size(arglist,2)~=2
  error('arglist must be of form {''ParameterTag1'',value1;''ParameterTag2'',value2}')
 end
narglist={'i', '__input';'m', '__input';'f', '__output'};
maxval={0,1,0};
minval={0,1,0};
istoggle=[0,1,0];
was_set=istoggle * 0;
...
[varargout{:}]=callKhoros([w 'vgettilt"  '],Inputs,narglist);
