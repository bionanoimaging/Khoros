%kkcolorspace 'Change the color space attribute on a data object'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros kcolorspace.pane file
%
% Parameters: 
% InputFile: i 'Input ', required: 'First Input data object'
% MultiChoice: type 'Image Colorspace', default: 1: 'Type of colorspace to be applied to the input image'
%    Choices are:
%   1: 'Greyscale'
%   2: 'RGB Colorspace'
%   3: 'CMY Colorspace'
...
%
% Example: o = kkcolorspace(i, {'i','';'type',1;'o',''})
%
...
function varargout = kkcolorspace(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkcolorspace(Inputs,arglist).');
end
if size(arglist,2)~=2
  error('arglist must be of form {''ParameterTag1'',value1;''ParameterTag2'',value2}')
 end
narglist={'i', '__input';'type', 1;'o', '__output'};
maxval={0,0,0};
minval={0,0,0};
istoggle=[0,0,0];
was_set=istoggle * 0;
...
[varargout{:}]=callKhoros([w 'kcolorspace"  '],Inputs,narglist);
