%kputpalette 'Non-Interactive Display of Color Palette'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros putpalette.pane file
%
% Parameters: 
...
%
% Example: kputpalette(i, {'i','';'x',-1;'width',256;'y',-1;'height',256;'update',2})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% putpalette - Non-Interactive Display of Color Palette
%
%  DESCRIPTION
% Putpalette is a visualization program that displays a color map as
% a palette of colors.
% 
% When displaying a color palette, it is possible to control how the palette
% is displayed or presented using the [-palettetype] argument.  There are 
% three different presentations of the color palette which include:
% 
%  "" 5
% 1 - Color Bar
% 2 - Color Cell
...
% other applications running at the same time; that is, it does not use a
% .I private 
% colormap, but rather makes use of the
% .I default 
...
% characteristic of private colormap installation.
% 
...
% other applications.
% 
% The input file containing the color data to be displayed in the palette
% is monitored by default; the file is checked every 2 seconds for change, 
% and if it has been modified, the palette is updated accordingly.  The
% interval at which the input file is checked for modification may be
% specified using the [-update] argument.
% 
% On creation, the window which displays the color palette may be placed
% manually (the default method), or placed automatically.  For automatic
% placement of the color palette window, specify the desired location in 
% device (screen) coordinates using the [-x] and [-y] arguments.
% 
% While the color palette display window should be created with a default
% size that is appropriate to display the data, a width and height for
% the window can be specified explicitly using the [-width] and [-height]
% arguments.  Alternatively, you may allow the palette display window
...
function varargout = kputpalette(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kputpalette(Inputs,arglist).');
end
if size(arglist,2)~=2
  error('arglist must be of form {''ParameterTag1'',value1;''ParameterTag2'',value2}')
 end
narglist={'i', '__input';'x', -1;'width', 256;'y', -1;'height', 256;'update', 2};
...
callKhoros([w 'putdata"  -palette'],Inputs,narglist);
