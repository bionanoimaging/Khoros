%kckfromRGBNTSC 'convert from RGB NTSC to other color coordinate systems'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros ckfromRGBNTSC.pane file
%
% Parameters: 
% InputFile: i 'Input RGB', required: 'Input RGB data object'
...
%
% Example: o = kckfromRGBNTSC(i, {'i','';'o','';'rgbcie',0;'retinalcone',0;'sowstar',0;'rgbsmpte',0;'uvy',0;'ihs',0;'xyz',0;'xyy',0;'hsv',0;'uvw',0;'uvwstar',0;'hls',0;'yiq',0;'labstar',0;'cmy',0;'yuv',0;'luvstar',0;'cmyk',0;'i1i2i3',0;'lhcstar',0})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% ckfromRGBNTSC - convert from RGB NTSC to other color coordinate systems
%
%  DESCRIPTION
% Convert from RGB NTSC (the "normal" RGB images used in computers) to another color coordinate system. The supported output color coordinate systems are:
% RGB CIE - The 1931 CIE standard primary reference system
% RGB SMPTE - The Society of Motion Picture and Television Engineers receiver primary system
% XYZ - System where the tristimulus required to match a color are always positive
...
% L*a*b* - Simple system that almost matches Munsell color system
...
% HLS - Hue, Lightness, Saturation system
% CMY - The subtractive Cyan, Magenta, Yellow system
% CMYK - The subtractive Cyan, Magenta, Yellow and Black
% I1I2I3 - The I1I2I3 system based on RGB
%
%  
%
%  EXAMPLES
% All examples for the toolbox COLOR are on the file $COLOR/Readme.html
%
%  "SEE ALSO"
% cktoRGBNTSC
%
...
function varargout = kckfromRGBNTSC(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kckfromRGBNTSC(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'ckfromRGBNTSC"  '],Inputs,narglist);
