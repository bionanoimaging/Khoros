%kgquadmesh 'Create a Quadmesh Geometry Object from 2D Data'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros gquadmesh.pane file
%
% Parameters: 
% InputFile: i 'Input 2D Data Object', required: 'input 2d data for quadmesh'
% String: name 'Name ', default: 'quadmesh': 'object name'
% OutputFile: o 'Output Geometry Quadmesh', required: 'ouput geometry quadmesh'
% InputFile: cmap 'Vis Colormap', optional: 'input vis colormap'
% Toggle: tc2d 'Generate 2D Texture Coords', default: 0: 'generate 2D texture coords'
% Toggle: tc3d 'Generate 3D Texture Coords', default: 0: 'generate 3D texture coords'
%
% Example: o = kgquadmesh({i, cmap}, {'i','';'name','quadmesh';'o','';'cmap','';'tc2d',0;'tc3d',0})
%
...
function varargout = kgquadmesh(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kgquadmesh(Inputs,arglist).');
end
if size(arglist,2)~=2
  error('arglist must be of form {''ParameterTag1'',value1;''ParameterTag2'',value2}')
 end
narglist={'i', '__input';'name', 'quadmesh';'o', '__output';'cmap', '__input';'tc2d', 0;'tc3d', 0};
maxval={0,0,0,1,0,0};
minval={0,0,0,1,0,0};
istoggle=[0,1,0,1,1,1];
was_set=istoggle * 0;
paramtype={'InputFile','String','OutputFile','InputFile','Toggle','Toggle'};
...
[varargout{:}]=callKhoros([w 'gquadmesh"  '],Inputs,narglist);
