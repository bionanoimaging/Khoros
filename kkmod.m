%kkmod 'Output = Remainder of [Input 1 / (Input 2 or Constant)]'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros kmod.pane file
%
% Parameters: 
...
%
% Example: o = kkmod({i1, i2}, {'i1','';'o','';'i2',''})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% kmod - Output = Remainder of [Input 1 / (Input 2 or Constant)]
%
%  DESCRIPTION
% The "Modulus" operator returns the remainder of the result 
% produced by dividing each point in \fBInput 1" by
% either \fBInput 2" or the \fBConstant\fP value, which 
% ever is specified by the user.
% 
% Executing "Modulus" runs the program \fIkarith2\fP with the -mod flag.
% 
...
function varargout = kkmod(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkmod(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'karith2"  -mod'],Inputs,narglist);
