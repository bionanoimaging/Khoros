%kkdiv 'Output = Input 1 / (Input 2 or Constant)'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros kdiv.pane file
%
% Parameters: 
...
%
% Example: o = kkdiv({i1, i2}, {'i1','';'o','';'i2',''})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% kdiv - Output = Input 1 / (Input 2 or Constant)
%
%  DESCRIPTION
% The "Divide" operator divides each point in \fBInput 1\fP by
% either \fBInput 2" or the \fBConstant\fP value, which 
% ever is specified by the user.
% 
% Executing "Divide" runs the program \fIkarith2\fP with the -div flag.
% 
% 
...
%
%  "SEE ALSO"
% DATAMANIP::karith2, DATAMANIP::kdivinto
%
%  RESTRICTIONS 
%
%  REFERENCES 
...
function varargout = kkdiv(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkdiv(Inputs,arglist).');
end
if size(arglist,2)~=2
