%kkexpon 'Introduce Exponential Noise in Input Object'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros kexpon.pane file
%
% Parameters: 
...
%
% Example: o = kkexpon(i, {'i','';'o','';'replace',0;'add',0})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% kexpon - Introduce Exponential Noise in Input Object
%
%  DESCRIPTION
% "kexpon" introduces exponential noise of the specified parameters in the
...
% The variance (-evar) of the exponential distribution
% must be specified.
% 
%  "Data Type" 5
...
function varargout = kkexpon(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkexpon(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'knoise"  -exp'],Inputs,narglist);
