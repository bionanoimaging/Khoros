%kkbitor 'Output = Input 1 OR (Input 2 or Constant)'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros kbitor.pane file
%
% Parameters: 
...
%
% Example: o = kkbitor({i1, i2}, {'i1','';'o','';'i2','';'real',0})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% kbitor - Output = Input 1  OR  (Input 2 or Constant)
%
%  DESCRIPTION
% The bitwise OR operator performs a bitwise OR between each point in
...
% 
% Executing \fBOR" runs the program "kbitwise\fP with the -or flag.
%
%  
%
%  EXAMPLES
...
function varargout = kkbitor(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkbitor(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'kbitwise"  -or'],Inputs,narglist);
