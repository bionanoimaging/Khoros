%kkne 'IF Input 1 is Not Equal to (Input 2 or Constant), Output = TRUE'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros kne.pane file
%
% Parameters: 
...
%
% Example: o = kkne({i1, i2}, {'i1','';'o','';'i2',''})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% kne - IF Input 1 is Not Equal to (Input 2 or Constant), Output = TRUE
%
%  DESCRIPTION
% The NOT EQUAL comparison operator compares each point in \fBInput 1"
% either with the corresponding point in \fBInput 2" or with the
% \fBConstant" value, which ever is specified by the user.
% If the two values are not equal, the corresponding point in \fBOutput" will be
% assigned the value specified by \fBTRUE Value".  It the values being
% compared are equal, the corresponding point in \fBOutput" will be
...
% 
% Executing the Not Equal operator runs the program "kcompare" with 
% the -ne flag.
%
%  
%
...
function varargout = kkne(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkne(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'kcompare"  -ne'],Inputs,narglist);
