%kkge 'IF Input1 is Greater or Equal to (Input2 or Constant), Output = TRUE'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros kge.pane file
%
% Parameters: 
...
%
% Example: o = kkge({i1, i2}, {'i1','';'o','';'i2',''})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% kge - IF Input1 is Greater or Equal to (Input2 or Constant), Output = TRUE
%
%  DESCRIPTION
% The GREATER or EQUAL comparison operator compares each point in \fBInput 1"
% either with the corresponding point in \fBInput 2" or with the
% \fBConstant" value, which ever is specified by the user.
% If the value from \fBInput 1" is greater than or equal to the 
% value from \fBInput 2" or the \fBConstant\fP, the corresponding point 
% in \fBOutput" will be
% assigned the value specified by \fBTRUE Value".  If the value from 
% \fBInput 1" is not greater than or equal to the value against which
% it is being compared, the corresponding point in \fBOutput" will be
% the value specified by \fBFALSE Value".
% 
...
% 
% Executing the Greater Than or Equal operator  runs the program "kcompare" 
% with the -ge flag.
%
%  
%
...
function varargout = kkge(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkge(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'kcompare"  -ge'],Inputs,narglist);
