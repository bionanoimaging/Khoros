%kkrayleigh 'Introduce Rayleigh Noise in Input Object'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros krayleigh.pane file
%
% Parameters: 
...
%
% Example: o = kkrayleigh(i, {'i','';'o','';'replace',0;'add',0})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% krayleigh - Introduce Rayleigh Noise in Input Object
%
%  DESCRIPTION
% "krayleigh" introduces Rayleigh noise of the specified parameters in the
...
% The variance (-rvar) of the Rayleigh distribution
% must be specified.
% 
%  "Data Type" 5
...
% DATAMANIP::kpoisson, DATAMANIP::kuniform
%
%  RESTRICTIONS 
%
%  REFERENCES 
...
function varargout = kkrayleigh(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkrayleigh(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'knoise"  -ray'],Inputs,narglist);
