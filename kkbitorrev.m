%kkbitorrev 'Output = Input 1 OR NOT(Input 2 or Constant)'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros kbitorrev.pane file
%
% Parameters: 
...
%
% Example: o = kkbitorrev({i1, i2}, {'i1','';'o','';'i2','';'real',1})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% kbitorrev - Output = Input 1  OR  NOT(Input 2 or Constant)
%
%  DESCRIPTION
% The bitwise OR Reverse operator performs a bitwise NOT on either
% \fBInput 2" or the \fBConstant\fP value, which ever is specified
% by the user, and then performs a bitwise OR between the result of the
...
% 
% Executing \fBOR Reverse" runs the program "kbitwise\fP with the -orrev flag.
%
%  
%
%  EXAMPLES
...
function varargout = kkbitorrev(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkbitorrev(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'kbitwise"  -orrev'],Inputs,narglist);
