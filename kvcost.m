%kvcost 'Compute Cost (Surface Arc Length) for Image (K1)'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros vcost.pane file
%
% Parameters: 
% InputFile: i 'Input Image ', required: 'input image'
% InputFile: m 'Mask Image ', optional: 'mask image'
% Integer: x 'X coordinate of reference pixel', default: 0: 'X coordinate of reference pixel'
% Integer: y 'Y coordinate of reference pixel', default: 0: 'Y coordinate of reference pixel'
% OutputFile: o 'Output Image ', required: 'output image'
%
% Example: o = kvcost({i, m}, {'i','';'m','';'x',0;'y',0;'o',''})
%
...
function varargout = kvcost(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kvcost(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'vcost"  '],Inputs,narglist);
