%kvdist 'Distance Transform of binary image'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros vdist.pane file
%
% Parameters: 
% InputFile: i 'Input Image', required: 'input image'
% MultiChoice: cv 'Distance Function Type', default: 3: 'dist. function'
%    Choices are:
%   1: 'Euclidean'
%   2: '4-connectivity City Block'
%   3: '8-connectivity City Block'
% OutputFile: o 'Output Image', required: 'resulting output image'
%
% Example: o = kvdist(i, {'i','';'cv',3;'o',''})
%
...
function varargout = kvdist(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kvdist(Inputs,arglist).');
end
if size(arglist,2)~=2
  error('arglist must be of form {''ParameterTag1'',value1;''ParameterTag2'',value2}')
 end
narglist={'i', '__input';'cv', 3;'o', '__output'};
maxval={0,0,0};
minval={0,0,0};
istoggle=[0,0,0];
was_set=istoggle * 0;
...
[varargout{:}]=callKhoros([w 'vdist"  '],Inputs,narglist);
