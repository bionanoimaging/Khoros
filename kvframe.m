%kvframe 'Builds a frame image'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros vframe.pane file
%
% Parameters: 
% InputFile: i 'Input Image', required: 'input image'
% OutputFile: o 'Output Image ', required: 'resulting output image'
%
% Example: o = kvframe(i, {'i','';'o',''})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% vframe - Builds a frame image
%
%  DESCRIPTION
% .I vframe
...
function varargout = kvframe(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kvframe(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'vframe"  '],Inputs,narglist);
