%kkshot 'Introduce Shot Noise in Input Object'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros kshot.pane file
%
% Parameters: 
% InputFile: i 'Input File', required: 'Input File'
% OutputFile: o 'Output File', required: 'Output File'
%
% Example: o = kkshot(i, {'i','';'o',''})
%
...
function varargout = kkshot(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkshot(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'kshot"  '],Inputs,narglist);
