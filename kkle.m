%kkle 'IF Input 1 is Less or Equal to (Input 2 or Constant), Output = TRUE'
% This MatLab function was automatically generated by a converter (KhorosToMatLab) from the Khoros kle.pane file
%
% Parameters: 
...
%
% Example: o = kkle({i1, i2}, {'i1','';'o','';'i2',''})
%
% Khoros helpfile follows below:
%
%  PROGRAM
% kle - IF Input 1 is Less or Equal to (Input 2 or Constant), Output = TRUE
%
%  DESCRIPTION
% The LESS or EQUAL comparison operator compares each point in \fBInput 1"
% either with the corresponding point in \fBInput 2" or with the
% \fBConstant" value, which ever is specified by the user.
% If the value from \fBInput 1" is less than or equal to the
...
% \fBInput 1" is not less than or equal to the value against which
...
% 
% Executing the Less Than or Equal operator runs the program "kcompare" 
% with the -le flag.
%
%  
%
...
function varargout = kkle(varargin)
if nargin ==0
  Inputs={};arglist={'',''};
elseif nargin ==1
...
else error('Usage: [out1,..] = kkle(Inputs,arglist).');
end
if size(arglist,2)~=2
...
[varargout{:}]=callKhoros([w 'kcompare"  -le'],Inputs,narglist);
